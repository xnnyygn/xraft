...
//        ));
//        Assert.assertTrue(log.appendEntries(rpc.getPrevLogIndex(), rpc.getPrevLogTerm(), rpc.getEntries()));
...
//    }
    ...
    public void testAppendEntriesPrevLogNotFound() {
        ...
        Assert.assertFalse(log.appendEntries(rpc.getPrevLogIndex(), rpc.getPrevLogTerm(), rpc.getEntries()));
    }
